...
export const products = [
  ...
  { id: "p7", category_id: "c8", name: "Common Nails 3\"", sku: "NAI-COM3", barcode: "8850001001240", primary_unit: "kg", stock_quantity: 45, reorder_level: 15, cost_price: 65, selling_price: 85, is_active: true, image_placeholder: "🔩", supplier_lead_time_days: 5, minimum_purchase_units: 1 },
  ...
  { id: "p9", category_id: "c7", name: "Hacksaw Blade", sku: "TOL-HSB", barcode: "8850001001242", primary_unit: "piece", stock_quantity: 5, reorder_level: 10, cost_price: 25, selling_price: 40, is_active: true, image_placeholder: "🛠️", notes: "Fast mover in Q2; keep a buffer near checkout." },
